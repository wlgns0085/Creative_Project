...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_pos = nh.subscribe("/bebop/states/ardrone3/PilotingState/PositionChanged", 1, att_callback);
